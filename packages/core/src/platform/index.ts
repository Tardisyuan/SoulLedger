 ...
 *
 * WHO CALLS IT. The WebSocket reconnect described in `SessionResumeSubscriber`,
 * in the host (`frontend/src/contexts/WebSocketContext.tsx`). The judgment
 * queue used it to re-check its undo window until that window was removed
 * (2026-09-25); nothing in this package calls it now.
 */
