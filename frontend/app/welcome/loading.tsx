    ...
    <div className="bg-[hsl(var(--color-canvas))]">
      <header className="border-b border-[hsl(var(--color-hairline))]">
        <div className="max-w-page mx-auto px-6 pt-10 pb-6">
          ...
          <div className="h-10 w-80 bg-[hsl(var(--color-hairline))] animate-pulse" />
      ...
      <div className="max-w-page mx-auto px-6 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-24 bg-[hsl(var(--color-hairline))] animate-pulse" />
          ))}
        </div>

        {/* Content skeleton */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 h-48 bg-[hsl(var(--color-hairline))] animate-pulse" />
          <div className="h-48 bg-[hsl(var(--color-hairline))] animate-pulse" />
        </div>
      </div>
    </div>
  );
