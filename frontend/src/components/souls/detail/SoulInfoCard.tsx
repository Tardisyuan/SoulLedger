      ...
      {loading ? (
        ...
        <dl className="space-y-2 text-03">
          ...
          <div className="flex justify-between">
            <dt className="text-[oklch(var(--color-ink-muted))]">{t("souls.civilization")}</dt>
            <dd className="text-[oklch(var(--color-ink))]"><DomainEnum namespace="souls.civilizations" value={soul?.civilization} /></dd>
          </div>
          <div className="flex justify-between gap-3">
            <dt className="text-[oklch(var(--color-ink-muted))] shrink-0">
            ...
            <dd className="text-[oklch(var(--color-ink))] text-right"><DomainText value={birthDisplay} /></dd>
          </div>
          <div className="flex justify-between">
            <dt className="text-[oklch(var(--color-ink-muted))]">{t("souls.detail.death")}</dt>
          ...
          <div className="flex justify-between">
            <dt className="text-[oklch(var(--color-ink-muted))]">{t("souls.detail.location_label")}</dt>
            <dd className="text-[oklch(var(--color-ink))]"><DomainText value={soul?.origin_location} /></dd>
          </div>
        </dl>
      )}
    </div>
