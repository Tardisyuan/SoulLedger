                ...
                {loading ? (
                  ...
                  <>
                    {searching ? (
                      <p
                        role="status"
                        className="px-3 py-2 text-2xs text-[oklch(var(--color-ink-tertiary))] border-b border-[oklch(var(--color-hairline))]"
                      >
                        {loadingText}
                      </p>
                    ) : null}
                    ...
                    {options.length === 0 ? (
                      <p className="px-3 py-2 text-xs text-[oklch(var(--color-ink-subtle))]">
                        {emptyText}
                      </p>
                    ) : null}
                    <Combobox.List>
                    ...
                    {/* Says the list is a slice, which the old `<select>` never
                        ...
                        reason to take. */}
                    {moreText ? (
                      <p className="px-3 py-2 text-2xs text-[oklch(var(--color-ink-tertiary))] border-t border-[oklch(var(--color-hairline))]">
                        {moreText}
                      </p>
                    ) : null}
                  </>
