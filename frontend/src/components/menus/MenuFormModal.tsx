  ...
  return (
    ...
    >
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            {/* IconPicker (src/components/ui/IconPicker.tsx) renders its own trigger button
                ...
                spelling (`text-2xs uppercase text-ink-subtle`) so it does not
                read as a different kind of label from the ones beside it. */}
            <span id={iconLabelId} className="text-2xs uppercase text-[oklch(var(--color-ink-subtle))]">
        ...
        <div className="flex flex-col gap-1">
          <span id={rolesLabelId} className="text-2xs uppercase text-[oklch(var(--color-ink-subtle))]">{t("menus.roles")}</span>
          ...
          <p className="text-xs text-[oklch(var(--color-ink-tertiary))]">{t("menus.roles_empty_hint")}</p>
        </div>
        <div className="flex flex-col gap-1">
          {isAdmin ? (
          ...
          <p className="text-xs text-[oklch(var(--color-ink-tertiary))]">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor={visibleId} className="text-sm text-[oklch(var(--color-ink))]">{t("menus.visible_label")}</label>
          </div>
          <p className="text-xs text-[oklch(var(--color-ink-tertiary))]">{t("menus.visible_hint")}</p>
        </div>
