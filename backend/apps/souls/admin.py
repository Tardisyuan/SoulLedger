...
class SoulAdmin(admin.ModelAdmin):
    list_display = ["name", "civilization", "current_state", "karmic_balance", "death_date", "created_at"]
    list_filter = ["civilization", "current_state"]
...
class SoulRecordAdmin(admin.ModelAdmin):
    list_display = ["soul", "record_type", "civilization", "weight", "recorded_at"]
    list_filter = ["record_type", "civilization"]
